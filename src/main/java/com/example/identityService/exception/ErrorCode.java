...
public enum ErrorCode {
    ...
    USERNAME_INVALID("Username must be at least {min} characters", 1002, HttpStatus.BAD_REQUEST),
    PASSWORD_INVALID("Password must be at least {min} characters", 1003, HttpStatus.BAD_REQUEST),
    ...
    INVALID_DOB("Your age must be at least {min}", 1009, HttpStatus.BAD_REQUEST)
    ;
